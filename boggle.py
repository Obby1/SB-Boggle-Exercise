...
class Boggle():
    ...
    def check_valid_word(self, board, word):
        ...
        # word exists in database and can be legally played
        if word_exists and valid_word:
            result = "ok"
        # words exists in db but cannot be legally played
        elif word_exists and not valid_word:
            result = "not-on-board"
        # word doesn't exist in db
        else:
            result = "not-word"

        return result

    # focus on other funcs as per SB
